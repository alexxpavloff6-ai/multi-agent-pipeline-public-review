...
| R1 | один полный полезный цикл точной конфигурации | RUN-025 завершён и принят как один цикл; формальная R1 ещё не принята после полной сверки шлюзов |
...
- RUN-025 подтвердил один полный полезный цикл точной конфигурации, включая
  независимое отклонение результата GLM, отдельную финализацию Codex и закрытие
  ядром.
...
Таблица фиксирует основные обезличенные копии документов 149–156. Полный
перечень публикационного комплекта, включая `README.md`, настоящий документ
157, исследования Orca и OMP, реестр литературы и гипотезу качества, хранится
в `SHA256SUMS.txt`; сам перечень не включает собственную контрольную сумму.
...
Статически проверены все текстовые файлы публикационного комплекта:
...
3. внутренние ссылки между включёнными файлами разрешаются;
4. внешние ссылки сохранены отдельно от внутренних доказательств;
5. проект всё ещё не имеет утверждённой лицензии, тега выпуска и независимой
   проверки обезличивания; открытый доступ включён отдельным решением
   владельца 25 июля 2026 года и не устраняет эти ограничения.
...
### 13.2. Публикационный комплект — подготовлен

Документы 59, 68, 149–157, 159, 160 и корневой `README.md`
собраны в отдельном репозитории. Машинные пути и прямые ссылки на закрытые
материалы удалены; внутренние связи проверены.

### 13.3. Открытый публичный доступ — включён решением владельца

25 июля 2026 года владелец отдельно разрешил открыть репозиторий. На момент
открытия сохраняются остаточные ограничения:
...
Открытый доступ означает возможность чтения и направления замечаний. Он не
подменяет лицензию, независимую проверку обезличивания или подтверждение
готовности продукта.
...
6. открытый доступ не должен толковаться как лицензия или подтверждение
   завершённой проверки прав и обезличивания;
...
После открытия настоящего комплекта документационная линия достигает этапа
публичного критического обсуждения. Дальнейшие действия разделяются:
...
Открытие доступа выполнено отдельным решением владельца 25 июля 2026 года.
Оставшиеся ограничения раздела 13.3 требуется устранить до выпуска с
утверждённой лицензией и заявлением о законченной проверке.
