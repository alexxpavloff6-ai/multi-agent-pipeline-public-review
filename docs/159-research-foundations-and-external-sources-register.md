...
Полная история изучения и замечания о границах каждого источника остаются в `memory/SOURCES.md`. Настоящий файл — самостоятельный указатель для чтения и профессионального обсуждения. Приватный адрес публикационного репозитория намеренно исключён из библиографии.
